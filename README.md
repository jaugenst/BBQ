...
6. The table generated by the measure is first saved. From the results, the total bacterial volume is calculated following this equation : $$Volume =\sum_{i=1}^\n A_ixZ_i$$ , where A is the total area measured in the slice _i_, and Z is the interval in um between 2 slices.
